...
public class DocumentaryRecycleAdapter extends RecyclerView.Adapter<DocumentaryRecycleAdapter.MyViewHolder> {
    ...
    public DocumentaryRecycleAdapter(Context context , List<String> mDatas, List<String> mTextDatas){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.item_documentaryrecycle,parent,false);
        ...
        public MyViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(itemView.getContext(), DocumentaryWebViewActivity.class);
