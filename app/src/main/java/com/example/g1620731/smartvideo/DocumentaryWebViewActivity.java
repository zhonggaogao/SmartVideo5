...
public class DocumentaryWebViewActivity extends Activity {
    ...
    private String documentaryurl = ImageUtil.DocumentaryUrls[0];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_documentary_web_view);
        initwidget();
        initData();
        initListener();
        Intent intent = getIntent();
        clickedposition = intent.getIntExtra("position",0);
        videowebview.loadUrl(documentaryurl);
    }

    @Override
    protected void onResume() {
        super.onResume();
        videowebview.loadUrl(ImageUtil.DocumentaryUrls[clickedposition]);
    }

    private void initData() {
        mDatas = new ArrayList<String>();
        for (int i =0; i < ImageUtil.DocumentaryUrls.length ; i++){
            String data = ImageUtil.DocumentaryUrls[i];
            mDatas.add(data);
        }
    }
...
//     mTestWebView.loadData("", "text/html; charset=UTF-8", null);
                DocumentaryWebViewActivity.this.finish();
                Log.i("testwebview", "===>>>2");
            }
        }
        return true;
...
//    setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        public void onReceivedTitle(WebView view, String title) {
            (DocumentaryWebViewActivity.this).setTitle(title);
        }
//   @Override
//  //当WebView进度改变时更新窗口进度
